...
public class Student {
 ...
 //--------------------------------본격적인 시작----------------------------------------------------------------------------------------------------------------------------
  ...
  public void signStud(){ 
        ...
        int isub = 0; //개설된 강의 목록 중에서 몇번째 강의를 선택할건지...
        String str = "";
        boolean bflag = false;
    ...
    public void printMyClassGradeList(){ 
        ...
        System.out.print("점수를 확인하고자 하는 번호를 입력하세요 : "); //1번. 비주얼 프로그래밍
        ...
        System.out.println( "과목 : " +this.mySubject.get(igrade).getLectName()
                         ...
                         + "점수 : " + this.mySubject.get(igrade).getScore(this));
        }
        else{
    ...
    public void printBill(){
        ...
        System.out.println("총 수강료는 " + totalCost + "입니다. ");
